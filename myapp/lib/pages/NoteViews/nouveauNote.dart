...
class NouveauNote extends StatefulWidget {
  const NouveauNote({super.key});

  @override
  State<NouveauNote> createState() => _NouveauNoteState();
}

class _NouveauNoteState extends State<NouveauNote> {
        ...
        children: <Widget>[
          TextFormField(
            ...
            onChanged: (value)async{
              ...
              setMatiere(matriculeController.text, niveauValue, parcoursValue);setMatiere(matriculeController.text, niveauValue, parcoursValue);
            },
          ...
          DropdownButtonHideUnderline(
            child: DropdownButton2<String>(
              ...
              onChanged: (String? value) {
                ...
                setMatiere(matriculeController.text, niveauValue, parcoursValue);
              },
  ...
  Future<void> setMatiere(String matricule,String niveau,String parcours) async {
    List<Matiere> listes=await matiereServ.getMatierePasdeNote(matricule, niveau, parcours);
  ...
  void submitData() async{
    ...
    Map<dynamic,dynamic> reponse=await noteServ.createNote(noty);
